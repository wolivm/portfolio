                  ...
                  <div className="row">
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                      <div className="slider-text-inner js-fullheight">
                        <div className="desc">
                          <h1>Oi! <br />Sou o Willian :)</h1>
                          <p><a className="btn btn-primary btn-learn" href="LINKPARAOCV" target="_blank" rel="noopener noreferrer">Currículo<i className="icon-download4" /></a></p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                      <div className="slider-text-inner">
                        <div className="desc">
                          <h1>Sou obsecado por experiência <br /> do usuário.</h1>
